...
#criteria_year, criteria_engine, criteria_price = search_criteria
criteria_year = int(input("Вкажіть рік випуску\n"))
criteria_engine = float(input("Вкажіть обʼєм двигуна\n"))
criteria_price = int(input("Вкажіть вартість\n"))
